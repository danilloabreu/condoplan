            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br/>
                    <div class="alert alert-danger text-center"><p><strong>Erro!</strong> Seu projeto não pode ser enviado, tentar novamente</p>
                        <p><a href='/condoplan/view/php/page/page_form_aprovacao_projeto.php'>Voltar</a><p>
                    </div>
                  </div>
                </div>
              </div>
